  ...
  return (
    <html lang={localeLabels[locale].htmlLang} className={fontClassName}>
      <body className="flex min-h-svh flex-col">
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:top-3 focus:left-3 focus:z-[60] focus:rounded-ctrl focus:bg-marine focus:px-4 focus:py-2 focus:text-on-dark"
        >
          {m.skipToContent}
        </a>
