...
export const home = {
  ...
  hero: {
    ...
    proofLabel: { bg: "Избрана работа", en: "Selected work" },
  },
  experience: {
    label: { bg: "Опит в среди", en: "Experience across" },
    heading: { bg: "Къде сме работили с реални процеси", en: "Where we have worked with real processes" },
    lead: {
      bg: "Това не е стена от клиенти. Всяко поле казва сектора и типа работа. Клиентска връзка се посочва само когато е потвърдена.",
      en: "This is not a client logo wall. Each item states the sector and type of work. A client relationship is named only when it is confirmed.",
    },
  },
  featured: {
    label: { bg: "Избрана работа", en: "Selected work" },
    heading: { bg: "Системи, които сме изграждали", en: "Systems we have built" },
    lead: {
      bg: "Проектите показват способност. Не са пакети за продажба. Липсващите факти са маркирани, не са дописани.",
      en: "Projects demonstrate capability. They are not packages for sale. Missing facts are marked, not invented.",
    },
...
export const projectsPage = {
  ...
  statusVocab: {
    bg: [
      ...
      ["Вътрешна R&D", "Вътрешна разработка или прототип, не оферта."],
      ["Предишна професионална работа", "Изградена система; връзката с ITT се потвърждава отделно."],
    ...
    en: [
      ...
      ["Previous professional work", "A built system; the ITT relationship is confirmed separately."],
