...
export const vikProektant = {
  ...
  compare: {
    ...
    waiting: { bg: "Отговорът се подготвя.", en: "The answer is being prepared." },
    idle: { bg: "Отговорът ще се появи тук.", en: "The answer will appear here." },
    sources: { bg: "Използвани източници", en: "Sources used" },
    ...
    errors: {
      ...
      rate_limited: { bg: "Твърде много сравнения за кратко време. Опитайте отново след малко.", en: "Too many comparisons in a short time. Try again shortly." },
