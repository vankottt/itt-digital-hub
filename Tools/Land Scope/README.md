...
Част от ITT Digital Hub сайта. Публичният продукт е `src/settlement-analyzer/` на `/{bg|en}/settlement-analyzer`. Тази папка е изходният код на същия инструмент, в същото репо — не отделен проект.
